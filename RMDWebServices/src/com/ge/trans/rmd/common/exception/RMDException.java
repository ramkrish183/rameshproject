...
public class RMDException {
     ...
     */
    public RMDException(final RMDServiceException exception) {

        this.setCode(exception.getErrorDetail().getErrorCode());
        this.setMessage(exception.getErrorDetail().getErrorMessage());
    }
