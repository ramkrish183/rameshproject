...
@XmlType(name = "geofences", propOrder = { "geozoneObjid","geoZoneId","geoZoneName","assetOwnerId","latitude1","longitude1","latitude3","longitude3","active","obsolete"})

@XmlRootElement
public class LDVRTemplateGeofences {
