...
@XmlType(name = "templateReportResponseType", propOrder = { "templateName", "templateDescription", "templateVersion",
...
@XmlRootElement
public class TemplateReportResponseType extends AssetResponseType {
