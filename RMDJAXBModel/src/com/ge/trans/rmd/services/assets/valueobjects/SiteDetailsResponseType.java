...
@XmlType(name = "siteDetailsResponseType", propOrder = { "strType",
        ...
        "strCreateType", "contactDetailsResponseType", "primAddObjId",
        "shipAddObjId", "billAddObjId", "strAddressEx", "strShipToEx",
        "strBillToEx", "strZipCode", "strCountry"})
@XmlRootElement
public class SiteDetailsResponseType {
    ...
    @XmlElement(required = true)
    protected List<ContactDetailsResponseType> contactDetailsResponseType;
    @XmlElement(required = true)
    ...
    public List<ContactDetailsResponseType> getContactDetailsResponseType() {
        return contactDetailsResponseType;
    }

    public void setContactDetailsResponseType(
            List<ContactDetailsResponseType> contactDetailsResponseType) {
        this.contactDetailsResponseType = contactDetailsResponseType;
    }
