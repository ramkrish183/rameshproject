...
@XmlType(name = "addUpdateContactRequestType", propOrder = { "contactObjId",
        ...
        "voiceMail", "actionFrom", "checkDupContact", "roleChanged",
        "siteChanged", "oldLocObjId" })
@XmlRootElement
public class AddUpdateContactRequestType {
    ...
    @XmlElement(required = true)
    protected String checkDupContact;
    @XmlElement(required = true)
    protected boolean roleChanged;
    @XmlElement(required = true)
    protected boolean siteChanged;
    @XmlElement(required = true)
    protected String oldLocObjId;
    ...
    public String getCheckDupContact() {
        return checkDupContact;
    }

    public void setCheckDupContact(String checkDupContact) {
        this.checkDupContact = checkDupContact;
    }
    ...
    public void setSiteChanged(boolean siteChanged) {
        this.siteChanged = siteChanged;
    }

    public String getOldLocObjId() {
        return oldLocObjId;
    }

    public void setOldLocObjId(String oldLocObjId) {
        this.oldLocObjId = oldLocObjId;
    }
