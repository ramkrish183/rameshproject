...
@XmlType(name = "FRDResponseType", propOrder = { "configId", "template",
		...
		"faultStart","faultEnd","controllerName","arlFRDRequestType","userName","action","tempVersion","ctrlSourceId"

})

@XmlRootElement
public class FRDRequestType {
	...
	@XmlElement(required = true)
	protected List<FRDRequestType> arlFRDRequestType;
	@XmlElement(required = true)
	...
	public List<FRDRequestType> getArlFRDRequestType() {
		return arlFRDRequestType;
	}
	public void setArlFRDRequestType(List<FRDRequestType> lstconfigRequestType) {
		this.arlFRDRequestType = lstconfigRequestType;
	}
	...
	public String getCtrlSourceId() {
		return ctrlSourceId;
	}
	public void setCtrlSourceId(String ctrlSourceId) {
		this.ctrlSourceId = ctrlSourceId;
	}
