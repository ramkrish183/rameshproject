...
@XmlType(name = "milePostDetailsRequestType", propOrder = { "milePostObjId", "activeFlag", "milePostId", "milePostDesc",
        "stateProvince", "region", "subRegion", "gpsLat", "gpsLon", "userId", "customerName", "arlMPDetailslRequestType"

})
@XmlRootElement
public class MilePostDetailsRequestType {
    ...
    @XmlElement(required = true)
    protected List<MilePostDetailsRequestType> arlMPDetailslRequestType;
    ...
    /**
     * @return the arlMPDetailslRequestType
     */
    public List<MilePostDetailsRequestType> getarlMPDetailslRequestType() {
        return arlMPDetailslRequestType;
    }

    /**
     * @param arlMPDetailslRequestType
     *            the arlMPDetailslRequestType to set
     */
    public void setarlMPDetailslRequestType(List<MilePostDetailsRequestType> arlMPDetailslRequestType) {
        this.arlMPDetailslRequestType = arlMPDetailslRequestType;
    }
