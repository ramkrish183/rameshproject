/**
 * ============================================================
 * File : FaultServiceStgyServiceIntf.java
 * Description :
 * Package : com.ge.trans.rmd.services.tools.fault.service.intf;
 ...
 * ============================================================
 */
package com.ge.trans.eoa.services.tools.fault.service.intf;
 ...
 * @History :
 ******************************************************************************/
public interface FaultServiceStgyServiceIntf {
     ...
     */
    FaultServiceStgyServiceVO findFault(FaultServiceStgyServiceVO objFaultServiceStgyServiceVO)
            throws RMDServiceException;
    ...
    List getLoadFaultClasses(FaultServiceStgyServiceVO objFaultServiceStgyServiceVO) throws RMDServiceException;
     ...
     */
    String saveUpdate(FaultServiceStgyServiceVO objFaultServiceStgyServiceVO, String strUserId)
            throws RMDServiceException;
     ...
     * @throws RMDServiceException
     */
    void updateFaultServiceStrategy(FaultServiceStrategyVO objFaultServiceStrategyVO) throws RMDServiceException;
